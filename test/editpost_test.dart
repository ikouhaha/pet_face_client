...
void main() {
  ...
  testWidgets('load edit post page have account', (tester) async {
    final user = MockUser(
      isAnonymous: false,
      uid: 'someuid',
    ...
    await tester
        .pumpWidget(createWidgetForTesting(child: EditPostPage(user:user,pid:"36")));

    await tester.pumpAndSettle();
  });

   testWidgets('load edit post page no account', (tester) async {
    ...
    SharedPreferencesService.saveProfile(profile);
    await tester
        .pumpWidget(createWidgetForTesting(child: EditPostPage()));
