...
import 'package:pet_saver_client/pages/scaffold_body.dart';
...
return MaterialApp(
  ...
  testWidgets('load scaffold body page', (tester) async {
   
    await tester.pumpWidget(createWidgetForTesting(child: const BookstoreScaffoldBody()));
